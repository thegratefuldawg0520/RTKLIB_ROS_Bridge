...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ROSsocket1' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/doopy/Documents/sockets/socketROS/src/ROSsocket1/${idir}'.  Ask the maintainer 'doopy <doopy@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/doopy/Documents/sockets/socketROS/devel/lib;/home/doopy/Documents/sockets/socketROS/devel/lib;/opt/ros/indigo/lib)
...
set(ROSsocket1_EXPORTED_TARGETS "")
